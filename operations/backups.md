...
2.  **PronterLabs Chat DB** (Postgres): Stores chat history and user accounts.
...
# Backup PronterLabs Chat
docker exec -t pronterlabs-chat-postgres-1 pg_dump -U postgres pronterlabs_chat > pronterlabs_chat_backup_$(date +%F).sql
